...
class StaffDentListPage extends StatefulWidget {
  final String clinicId;

  const StaffDentListPage({super.key, required this.clinicId});

  @override
  _StaffDentListPageState createState() => _StaffDentListPageState();
}

class _StaffDentListPageState extends State<StaffDentListPage> {
  ...
  Future<void> _fetchDentists() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error fetching dentist: $e')),
      );
      setState(() {
        isLoading = false;
      });
