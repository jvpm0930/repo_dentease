...
class StaffAddService extends StatefulWidget {
  ...
  const StaffAddService({super.key, required this.clinicId});

  @override
  _StaffAddServiceState createState() => _StaffAddServiceState();
}
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _buildTextField(servNameController, 'Service Name', Icons.medical_services),
                const SizedBox(height: 10),
                _buildTextField(servPriceController, 'Service Price', Icons.price_change),
                const SizedBox(height: 10),
                _buildTextField(
